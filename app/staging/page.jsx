...
export default function Staging() {
  ...
  return (
    <main>
      ...
      <div className="h-[50vh] md:min-h-screen flex items-center justify-start p-8 bg-cover bg-center relative" style={{ backgroundImage: 'linear-gradient(to bottom, rgba(0, 0, 0, 0), rgba(0, 0, 0, 1)), url(/1.png)' }}>
