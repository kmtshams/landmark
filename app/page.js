...
export default function Home() {
  ...
  return (
    <main>
      <div className="min-h-screen flex items-center justify-start p-8 bg-red-100 bg-cover bg-center relative" style={{ backgroundImage: 'linear-gradient(to bottom, rgba(0, 0, 0, 0), rgba(0, 0, 0, 1)), url(/1.jpg)' }}>
        <div className="max-w-2xl text-white bg-landmark-green/30 backdrop-blur-sm w-1/2 p-10">
          <h1 className="mb-4 text-6xl font-bold">Luxury living with no limits.</h1>
